...
user_command_count = {}
SPAM_WINDOW_SECONDS = 5  # Set the time window for spam checks
SPAM_THRESHOLD = 2
...
async def play_commnd(
    ...
    # --- AUDIO/VIDEO MODE FIX START ---
    # Agar command 'v' se start nahi hoti, toh video ko hamesha None (Audio) kar do
    command_name = message.command[0].lower()
    if not command_name.startswith("v") and not command_name.startswith("cv"):
        video = None
    else:
        video = True
    # --- FIX END ---
